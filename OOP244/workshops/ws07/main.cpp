...
// Revision History
/**********************************************************************
 Yoojin Lee, ylee237@myseneca.ca, 188162218, July 13 2023
***********************************************************************/
...
{
	{
		...
		cout << aVehicle << endl << endl; // | 2010 | VVV-111 | Factory

		aVehicle.moveTo("Downtown Toronto");
		aVehicle.moveTo("Mississauga");
		aVehicle.moveTo("North York");

		cout << endl << aVehicle << endl << endl; // | 2010 | VVV-111 | North York

		printHeader("T2: Read/Write");
		cin >> aVehicle; // Built year | License plate | Current location
		cout << endl << aVehicle << endl << endl; // | 2020 | abc-111 | Toronto
	}
